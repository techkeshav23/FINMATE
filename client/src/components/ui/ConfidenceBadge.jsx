            ...
            <div className="pt-2 border-t border-dark-700">
              ...
              <ul className="space-y-1">
                {assumptions.map((assumption, idx) => (
                  <li key={idx} className="flex items-start gap-2 text-dark-400">
          ...
          {dataQuality && (
            <div className="pt-2 border-t border-dark-700">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-dark-400">{dataQuality.score}%</span>
              </div>
              {dataQuality.note && (
                <p className="text-dark-500 mt-1">{dataQuality.note}</p>
              )}
            </div>
          )}
        </div>
