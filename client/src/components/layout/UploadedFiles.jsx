 ...
 */
const UploadedFiles = ({ files, onDeleteFile }) => {
      ...
      {expanded && (
        <div className="space-y-1 mt-1">
          {files.map((file) => (
            <div
              key={file.id}
              className="group relative bg-white border border-gray-200 rounded-lg p-2.5 hover:border-gray-300 transition-colors"
            >
